...
; CHECK-NEXT:    [[VEC_PHI41:%.*]] = phi <2 x i64> [ [[TMP57]], %[[VEC_EPILOG_PH]] ], [ [[TMP58:%.*]], %[[VEC_EPILOG_VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP84:%.*]] = add i64 [[INDEX38]], 0
; CHECK-NEXT:    [[NEXT_GEP42:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP84]]
; CHECK-NEXT:    [[TMP85:%.*]] = getelementptr i8, ptr [[NEXT_GEP42]], i32 0
; CHECK-NEXT:    [[WIDE_LOAD43:%.*]] = load <2 x i8>, ptr [[TMP85]], align 1
; CHECK-NEXT:    [[TMP86:%.*]] = zext <2 x i8> [[WIDE_LOAD43]] to <2 x i64>
; CHECK-NEXT:    [[TMP87:%.*]] = shl <2 x i64> [[VEC_IND27]], splat (i64 1)
; CHECK-NEXT:    [[TMP88:%.*]] = shl <2 x i64> [[TMP86]], [[TMP87]]
; CHECK-NEXT:    [[TMP58]] = or <2 x i64> [[TMP88]], [[VEC_PHI41]]
